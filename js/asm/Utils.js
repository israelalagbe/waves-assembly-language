        ...
        return {
            ...
            constructor: function() {
                InstrBuilder.Opcodes = {
                    ...
                    GOTO_OP: {
                        code: 6,
                        size: 2,//1 byte opcode, 1 for index into local label routine table
                        operand_count: 1,
                    ...
                    GET_OP: {
                        code: 8,
                        size: 4,//1 byte opcode,1 for reg, 2 for index into constant table
                        operand_count: 2,
                        operands: [InstrBuilder.Operands.Reg, InstrBuilder.Operands.Identifier]
                    },
                    LOAD_OP: {
                        code: 9,
                        size: 4,//1 byte opcode,1 for reg, 1 for reg, 1 for null
                        operand_count: 2,
                    ...
                    RETURN_OP: {
                        code: 12,
                        size: 2,//1 byte opcode,1 for reg
                        operand_count: 1,
                    ...
                    IF_EQ_OP: {
                        code: 14,
                        size: 4,//1 byte opcode,1 for reg,1 for reg,1 for index into routine list
                        operand_count: 3,
